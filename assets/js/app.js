(function ($) {
      ...
      series: [
        {
          name: "Revenue",
          data: [
            0.8, 1.3, 2.5, 2.1, 1.3, 2.4, 0.6, 2.4, 2.1, 1.5, 2.2, 0.6, 1.0,
            1.5, 2.1, 1.9, 2.4, 2.1, 1.5, 2.2, 1, 0.4,
          ],
        },
      ],
      chart: {
  ...
  if ($("#revenue-chart3").length > 0) {
    ...
    var chart = new ApexCharts(
      document.querySelector("#revenue-chart3"),
      options
    );
    chart.render();
  }
  if ($("#revenue-chart4").length > 0) {
    ...
    var chart = new ApexCharts(
      document.querySelector("#revenue-chart4"),
      options
    );
    chart.render();
  }
  ...
  if ($("#pro-task").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#pro-task"), options);
    chart.render();
  }
